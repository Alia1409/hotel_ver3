...
public class MainApp extends JFrame {
    ...
    private JPanel buildOccupancyView() {
        ...
        JLabel dateLabel = new JLabel("Target Verification Date (YYYY-MM-DD):");
        JTextField txtTargetDate = new JTextField(LocalDate.now().toString(), 10);
        ...
        Runnable refreshMap = () -> {
            ...
            model.clear();
            try {
                LocalDate targetDate = LocalDate.parse(txtTargetDate.getText().trim());
                ...
                JOptionPane.showMessageDialog(this, "Invalid date format applied.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        };
    ...
    private JPanel buildReservationView() {
        ...
        String[] cols = {"ID", "Room", "Guest", "Check-In", "Check-Out", "Bill", "Status"};
        ...
        Runnable refreshResTable = () -> {
            ...
            for (Reservation r : resService.getAllReservations()) {
                ...
                if (!dateQuery.isEmpty() && !r.getCheckInDate().toString().contains(dateQuery)) continue;
                ...
                resTableModel.addRow(new Object[]{r.getId(), r.getRoomNumber(), r.getGuestName(), 
                        r.getCheckInDate(), r.getCheckOutDate(), r.getTotalAmount(price), r.getStatus()});
            }
        };
        ...
        Runnable clearFormFields = () -> {
            ...
            txtPhone.setText(""); txtIn.setText(LocalDate.now().toString()); 
            txtOut.setText(LocalDate.now().plusDays(1).toString()); txtStatus.setText("confirmed");
        ...
        table.getSelectionModel().addListSelectionListener(e -> {
            ...
            if (row >= 0 && !e.getValueIsAdjusting()) {
                ...
                if (target != null) {
                    txtId.setText(target.getId()); txtRoomNum.setText(target.getRoomNumber());
                    txtName.setText(target.getGuestName()); txtEmail.setText(target.getEmail());
                    txtPhone.setText(target.getPhone()); txtIn.setText(target.getCheckInDate().toString());
                    txtOut.setText(target.getCheckOutDate().toString()); txtStatus.setText(target.getStatus());
        ...
        btnCreate.addActionListener(e -> {
            ...
            try {
                Reservation r = new Reservation(inputId, txtRoomNum.getText().trim(), txtName.getText().trim(),
                        txtEmail.getText().trim(), inputPhone, LocalDate.parse(txtIn.getText().trim(), dateForm),
                ...
                JOptionPane.showMessageDialog(this, "Check parameter fields.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
            ...
            if (selectedReservationId != null) {
                ...
                try {
                    Reservation r = new Reservation(selectedReservationId, txtRoomNum.getText().trim(), txtName.getText().trim(),
                            txtEmail.getText().trim(), inputPhone, LocalDate.parse(txtIn.getText().trim()),
                            LocalDate.parse(txtOut.getText().trim()), txtStatus.getText().trim(), txtNotes.getText().trim());
                    ...
                    JOptionPane.showMessageDialog(this, "Date syntax error.", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
